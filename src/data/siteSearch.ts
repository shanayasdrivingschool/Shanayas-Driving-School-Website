...
const staticSearchItems: SiteSearchItem[] = [
  ...
  },
  {
    ...
    description: "Practice ICBC-style learner licence questions with instant feedback.",
    href: "/knowledge-test-practice",
    type: "Resource",
    keywords: ["knowledge test", "practice", "quiz", "learner", "icbc"],
  },
  {
    title: "Driver's Licence Guide",
    description: "Step-by-step newcomer guide to BC licensing stages, tests, and study resources.",
    href: "/newcomers-guide",
    type: "Resource",
    keywords: ["newcomer", "guide", "bc licence", "graduated licensing", "class 7"],
  },
  {
    title: "Blog",
