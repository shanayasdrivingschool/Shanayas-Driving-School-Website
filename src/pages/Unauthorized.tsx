...
const Unauthorized = () => {
  ...
  useEffect(() => {
    console.error("401 Error: Authorization required for route:", location.pathname);
  }, [location.pathname]);
        ...
        >
          ...
          <div className="flex items-end justify-center pb-24 pt-6 text-center sm:items-center sm:pb-28 sm:pt-10 md:pb-36">
            <div className="max-w-[min(100%,54rem)]">
              <p className="text-[clamp(0.9rem,2.8vw,1.3rem)] font-semibold text-slate-100">Sign in required</p>
              <p className="mt-2 text-[clamp(4.5rem,18vw,8.5rem)] font-black leading-[0.88] text-white">
                4<span className="text-[#F5B13A]">0</span>1
              </p>
              <h1
              ...
              >
                You need to be signed in to view this page. Log in to your account to continue, or head back to the
                homepage.
              </p>
