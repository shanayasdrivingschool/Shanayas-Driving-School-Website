  ...
  <article className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
    <div className="flex items-start justify-between gap-4">
      <div>
        ...
        {/* Tabular figures keep every digit the same width, so a count ticking from 9 to 10,
            or a total refreshing behind a filter, does not shift the card's layout. */}
        <p className="mt-3 text-4xl font-black tabular-nums text-[#1d52a1]">{value}</p>
